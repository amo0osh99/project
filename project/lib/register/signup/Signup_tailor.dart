...
class SignupTaliorPage extends StatefulWidget {
    static const id =  '/SignupTaliorPage';
  @override
  _SignupTaliorPageState createState() => _SignupTaliorPageState();
}

class _SignupTaliorPageState extends State<SignupTaliorPage> {
  String email;
  String name;
  String phoneNumber;
  String passWord;
